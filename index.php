			...
			<article>
				<div class="row">
					...
					<h3>Welcome to my Blog</h3>
						<p>Hello and Welcome!!  My name is Chris Henrickson and I am currently attending Northeast Wisconsin Technical College studying to obtain an associate degree in Web Development.  In 2022-2023 I attended Lakeshore Technical College and completed a technical diploma as a Web Development Specialist.  My future plan is to become a Front-end developer or web designer.  I am creating this blog as a project to showcase some of my skills using, HTML5, CSS, Bootstrap5, PHP, and JavaScript.  Maybe even some jQuery.<br>Thank you for taking the time to check out my website!!</p>
					</div>
					<div class="col-md-3"></div>
				</div>
			</article>
